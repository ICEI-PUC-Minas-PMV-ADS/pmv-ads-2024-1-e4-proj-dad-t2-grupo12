...
| Conclusão do teste | Teste ainda será realizado na etapa de desenvolvimento mobile |
| Print dos Testes |
...
| Conclusão do teste | Ainda não integrado com o backend. A tela apresenta os inputs com login para inserir login e senha, bem como a opção de recuperar senha ou cadastrar-se. Inicialmente o botão de "Entrar" encaminha para a página inicial da aplicação |
| Print dos Testes |

![1](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e4-proj-dad-t2-grupo12/assets/114538749/12a0e960-3d0c-4092-a51c-324f648be2f6)
...
| Conclusão do teste | Ainda não integrado com o backend. Após o login o usuário administrador pode acessar o "Cadastro de colaboradores" no menu lateral. Nesta página há inputs onde são possíveis inserir informações nos campos relacionados ao cadastro do colaborador. O botão de "Cadastrar" ainda não está funcional. |
| Print dos Testes |

![2](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e4-proj-dad-t2-grupo12/assets/114538749/d6322673-2726-484a-9ec0-d7b4aeb5690a)
...
| Conclusão do teste | Ainda não integrado com o backend. No painel do colabroador é possivel visualizar os registros de horário do colaborador e acessar as solicitações. Ao acessar esta opção o usuario adminstrador é encaminahdo para uma página com a solicitação do colaborador onde exibe os registros de horários, justificativa e outros campos. O registro das informações ainda nao esta funcional e os botões de "cancelar" ou "salvar" encaminam para a página anterior |
| Print dos Testes |

![3](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e4-proj-dad-t2-grupo12/assets/114538749/344a3aa9-b04c-4e9c-8d30-92dcc91e1048)
...
| Conclusão do teste | Ainda não integrado com o backend. Na tela de perfil do colaborador, o usuário administrador pode alterar opções como desativar o acesso do colaborador a aplicação. Ainda não esta funcional nem registrando a alteração, mas é possível selecionar a opção desejada.  |
| Print dos Testes |

![4](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2024-1-e4-proj-dad-t2-grupo12/assets/114538749/804145d9-a0da-4f23-b808-fdc929c5ca49)
